<template>
    <header class="flex w-100 inline-flex items-center mw8 center">
        <div class="w-50-l w-40-m w-auto pv3 ph2 inline-flex items-center">
            ...
            <router-link to="/markets" :class="{ 'near-black':page=='markets','black-30':page!=='markets'}" class="ml2 pointer mt1 f5 fw6 link pa2 dn dib-ns" >
                Markets
            </router-link>

            <router-link to="/orders" :class="{ 'near-black':page=='orders','black-30':page!=='orders'}" class="mh2 pointer mt1 f5 fw6 link pa2 dn dib-ns" >
                Orders
            </router-link>

            <router-link to="/assets" :class="{ 'near-black':page=='assets','black-30':page!=='assets'}" class=" pointer mt1 f5 fw6 link pa2 dn dib-l" >
                Assets
            </router-link>

            <router-link to="/predict" :class="{ 'near-black':page=='predict','black-30':page!=='predict'}" class="ml2 pointer mt1 f5 fw6 link pa2 dn dib-l" >
                Predict
            </router-link>
        ...
        <div class="w-50-l w-60-m w-90 pv3 ph2 relative">
                ...
                <div class="pointer br3 fw6 bg-black-10 near-black ba b--black-10" @click="showSettings=showMenu=false,showAssets=!showAssets"> 
                    <div class="inline-flex items-center dim">
                        <p class="dib ma0 ph2 pv2 v-mid br3 br--left"> 
                            <small><i class="fa" :class="{'fa-caret-down':!showAssets,'fa-circle light-green':showAssets}" /></small> 
                            <img class="mr1 " style="width:0.75rem" v-if="getDefaultAsset.Exchange == 'crex24'" :src="logoCrex24"/>
                            <img class="mr1 " style="width:0.75rem" v-if="getDefaultAsset.Exchange == 'binance'" :src="logoBinance"/>
                            ...
                            <div class="bg-black-10 br3 w-100 h-100 overflow-scroll" style="max-height: 60vh;">
                                <div v-for="(asset, index) in getValuableAssets()" :key="index" class="w-100 inline-flex items-center dim ph2 pv3 bb b--black-05" @click="$store.dispatch('assets/setDefaultAsset', asset)">
                                    <p class="dib ma0 pr0 v-mid w-30 inline-flex items-center"> 
                                        <img class="mr1" style="width:0.75rem" v-if="asset.Exchange == 'crex24'" :src="logoCrex24"/>
                                        <img class="mr1" style="width:0.75rem" v-if="asset.Exchange == 'binance'" :src="logoBinance"/>    
                                        {{asset.Symbol}}
                                    </p>
                                ...
                                <div  class="w-100 dim pa2 tc bg-near-black mid-gray bb b--black-05"> zero balances are below </div>
                                <div id="emptyassets">
            ...
            <div class="w-100 relative fr pr2">
                <div v-if="showSettings" class="fade-in absolute mr2 top-2 right-1 bg-background br3 f6 z-max" style="width:10em">
                    <div @blur="showSettings=!showSettings" class="bg-black-10 h-100 flex flex-column br3 ">
                        ...
                        <div class="w-100 overflow-scroll pointer" style="max-height: 12rem;">
                            <div v-for="(market, index) in getEnabledMarkets()" :key="index" class="w-100 dim ph2 pv2 bb b--black-05">
                                <div class="w-100 inline-flex items-center justify-between">
                                    ...
                                    <i class="fr ml1 f7 fa fa-check-square black" @click="$store.dispatch('marketpairs/disableMarketPair', market),showSettings=!showSettings"/> 
                                </div>
                            ...
                            <div id="disabledmarket">
                                <div v-for="(market, index) in getDisabledMarkets()" :key="index*index" class="w-100 dim ph2 pv2 bb b--black-05">
                                    <div class="w-100 inline-flex items-center justify-between">
                                        <p class="dib ma0 pr0 v-mid inline-flex items-center"> 
                                            <small class="inline-flex items-center"> 
                                                <img class="mr1" style="width:0.75rem" v-if="market.Exchange == 'crex24'" :src="logoCrex24"/>
                                        ...
                                        <i class="fr ml1 f7 fa fa-square black-10" @click="$store.dispatch('marketpairs/enableMarketPair', market),showSettings=!showSettings"/> 
                                    </div>
                                    <p class="ma0 w-100 tr f7"> 
                                        <small class="ttu"> {{market.Exchange}}  </small>
                                    </p>
                        ...
                        <div class="w-100 justify-between dim ph2 pt2 bg-black br3 bb b--black-05">
                            <p class="items-center inline-flex w-100 dib pb0 ma0 ph0 v-mid white tc pointer" @click="$store.dispatch('marketpairs/restartMarketPair', ''),showSettings=!showSettings"> 
                ...
                <div v-if="showMenu" @click="showMenu=false" class="fade-in absolute mr2 top-2 right-0 bg-background br3 f6 z-max">
