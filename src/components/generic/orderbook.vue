    ...
    <div class="cf center f7 w-100 ph1" style="max-width:460px">
        ...
        <div :key="orderBookCount" class="fl w-100">
            ...
            <div class="fl w-50">
                ...
                <div style="height:6rem" class="inline-flex flex-column w-100 fl bl bb b--black-10 overflow-scroll">
            ...
            <div class="fl w-50">
                <div class="flex flex-row w-100 fl bg-black-10 fw6 f7">
                 ...
                 <div style="height:6rem" class="inline-flex flex-column w-100 fl br bl bb b--black-10 overflow-scroll">
