            ...
            <div class="dtc v-top br2 b--white pt5 w-100 vh-100">
                <div class="cf center card-marketpair br3 f5-ns f6 w-100 relative" style="max-width:240px">
                    ...
                    <div class="fl w-100 pa3 near-white pt3 f5 fw6 tc tl">
                        Welcome to Backpocket
                        <p class="db f7 fw0 white-30 i">
                            please enter login details or <br/>
                            <router-link to="/register" class="no-underline link fw0 white-70">click to sign up</router-link>
                        </p>
                    </div>
                    ...
                    <div class="fl w-100 tr pt2">
                        <router-link to="/forgot" class="frno-underline link fw0 white-30"><small class="i f7 ">forgot password?</small></router-link>
                    </div>
                        
                    <div class="fl w-100 pt4 pb2 tc f6">
                        <div v-if="lLogin" class="ph2 pv1 tc center pointer br2 bg-light-yellow dark-gray inline-flex items-center" @click="login()">
                            <span>sign in</span> <small><i class="pl1 fas fa-sign-in"></i></small>
                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            lLogin: true, notifications: [], username: "", password: "",
        };
    },
    methods: {
        keyUp(event) {
